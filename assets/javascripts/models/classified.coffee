...
module.exports = Backbone.Model.extend
  ...
  initialize: ->
    @url = =>
      id = @id
      if id then return "#{App.Resources.Config.hostname}/api/classified/#{id}"
      else "#{App.Resources.Config.hostname}/api/classified"
  ...
  parseVariables: ->
    ...
    @attributes.hostname = App.Resources.Config.hostname
